...
public class Solution {
    ...
    public static class Treap {
        ...
        public static class Node {
            ...
            private void print(Node node, List<Integer> list) {
                if (node == null) return;
    ...
    public static void main(String[] args) {
        ...
        Treap.Node root = new Treap.Node(Reader.nextInt(), random.nextInt());
        for (int i = 1; i < n; i++) {
            root = Treap.merge(root, new Treap.Node(Reader.nextInt(), random.nextInt()));
        }
        ...
        for (int i = 0; i < m; i++) {
            ...
            Treap.Node[] subResult1 = Treap.splitOrder(root, from - 1);
            Treap.Node first = subResult1[0];
            Treap.Node temp = subResult1[1];
            Treap.Node[] subResult2 = Treap.splitOrder(temp,
